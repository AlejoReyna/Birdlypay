...
export default function HomepageComponent () {
  ...
  const handlePaylink = () => {
    ...
    return (
        ...
        <div className="w-24 h-24 aspect-square bg-white rounded-lg shadow flex items-center justify-center
        ...
        <div className="w-24 h-24 aspect-square bg-gray-200 rounded-lg shadow flex items-center justify-center">
